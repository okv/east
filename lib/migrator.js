...
Migrator.prototype._nameRegExpStr = '^([0-9]+)_';
Migrator.prototype._nameRegExp = new RegExp(Migrator.prototype._nameRegExpStr);
Migrator.prototype._fileNameRegExp = new RegExp(
	Migrator.prototype._nameRegExpStr + '.*\.js$'
);
...
Migrator.prototype.normalizeNames = function(names, callback) {
	...
	function getBaseNameFromName(name) {
		return /_.*/.exec(name)[0].replace('_', '');
	}
};
